...
/**
 * Clase que representa la reduccion -&gt; binario : expresion DESP_D expresion
 *
 * @author César Pomar
 */
public final class BinDespD extends Binario{
     ...
     */
    public BinDespD(Expresion izquierda, Terminal operador, Expresion derecha) {
        super(operador);
