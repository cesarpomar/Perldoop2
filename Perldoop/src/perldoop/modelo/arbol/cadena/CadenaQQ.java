...
/**
 * Clase que representa la reduccion -&gt; cadena : QQ SEP cadenaTexto SEP
 *
 * @author César Pomar
 */
public final class CadenaQQ extends Cadena {
     ...
     */
    public CadenaQQ(Terminal id, Terminal sepI, CadenaTexto texto, Terminal sepD) {
