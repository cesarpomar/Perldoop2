...
/**
 * Clase que representa la reduccion -&gt; logico : expresion LLXOR expresion
 *
 * @author César Pomar
 */
public final class LogXorBajo extends Logico{
     ...
     */
    public LogXorBajo(Expresion izquierda, Terminal operador, Expresion derecha) {
        super(operador);
