 ...
 * @author César Pomar
 */
public final class CondicionalIf extends Condicional{
     ...
     */
    public CondicionalIf(Terminal ifT, AbrirBloque abrirBloque, Terminal parentesisI, Expresion expresion, Terminal parentesisD, Terminal llaveI, Cuerpo cuerpo, Terminal llaveD) {
        setIfT(ifT);
    ...
    public Simbolo[] getHijos() {
        return new Simbolo[]{ifT, abrirBloque, parentesisI, expresion, parentesisD, llaveI, cuerpo, llaveD};
    }
}
