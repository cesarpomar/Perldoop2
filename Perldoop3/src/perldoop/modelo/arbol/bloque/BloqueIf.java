...
/**
 * Clase que representa la reduccion -&gt;<br> bloque : IF '(' expresion ')' '{' cuerpo '}'
 *
 * @author César Pomar
 */
public final class BloqueIf extends BloqueControlBasico {
     ...
     */
    public BloqueIf(Terminal id, AbrirBloque abrirBloque, Terminal parentesisI, Expresion expresion, Terminal parentesisD, Terminal llaveI, Cuerpo cuerpo, Terminal llaveD) {
