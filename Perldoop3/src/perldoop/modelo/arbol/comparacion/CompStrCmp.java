...
/**
 * Clase que representa la reduccion -&gt; compracion : expresion CMP expresion
 *
 * @author César Pomar
 */
public final class CompStrCmp extends Comparacion {
     ...
     */
    public CompStrCmp(Expresion izquierda, Terminal operador, Expresion derecha) {
        super(operador);
