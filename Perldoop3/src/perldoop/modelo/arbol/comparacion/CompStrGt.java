...
/**
 * Clase que representa la reduccion -&gt; compracion : expresion STR_GT expresion
 *
 * @author César Pomar
 */
public final class CompStrGt extends Comparacion {
     ...
     */
    public CompStrGt(Expresion izquierda, Terminal operador, Expresion derecha) {
        super(operador);
