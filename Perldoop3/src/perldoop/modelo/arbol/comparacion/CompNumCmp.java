...
/**
 * Clase que representa la reduccion -&gt; compracion : expresion CMP_NUM expresion
 *
 * @author César Pomar
 */
public final class CompNumCmp extends Comparacion {
     ...
     */
    public CompNumCmp(Expresion izquierda, Terminal operador, Expresion derecha) {
        super(operador);
