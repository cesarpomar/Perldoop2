...
/**
 * Clase que representa la reduccion -&gt; compracion : expresion NUM_GE expresion
 *
 * @author César Pomar
 */
public final class CompNumGe extends Comparacion {
     ...
     */
    public CompNumGe(Expresion izquierda, Terminal operador, Expresion derecha) {
        super(operador);
