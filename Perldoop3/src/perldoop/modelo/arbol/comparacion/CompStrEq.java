...
/**
 * Clase que representa la reduccion -> compracion : expresion STR_EQ expresion
 *
 * @author César Pomar
 */
public final class CompStrEq extends Comparacion {
     ...
     */
    public CompStrEq(Expresion izquierda, Terminal operador, Expresion derecha) {
        super(operador);
