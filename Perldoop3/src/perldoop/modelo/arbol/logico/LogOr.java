...
/**
 * Clase que representa la reduccion -> logico : expresion LOR expresion
 *
 * @author César Pomar
 */
public final class LogOr extends Logico{
     ...
     */
    public LogOr(Expresion izquierda, Terminal operador, Expresion derecha) {
        super(operador);
