...
/**
 * Clase que representa la reduccion -&gt; logico : expresion DLOR expresion
 *
 * @author César Pomar
 */
public final class DLogOr extends Logico{
     ...
     */
    public DLogOr(Expresion izquierda, Terminal operador, Expresion derecha) {
        super(operador);
