...
/**
 * Clase que representa la reduccion -> logico : expresion LAND expresion
 *
 * @author César Pomar
 */
public final class LogAnd extends Logico{
     ...
     */
    public LogAnd(Expresion izquierda, Terminal operador, Expresion derecha) {
        super(operador);
