...
/**
 * Clase que representa la reduccion -&gt; logico : expresion LLOR expresion
 *
 * @author César Pomar
 */
public final class LogOrBajo extends Logico{
     ...
     */
    public LogOrBajo(Expresion izquierda, Terminal operador, Expresion derecha) {
        super(operador);
