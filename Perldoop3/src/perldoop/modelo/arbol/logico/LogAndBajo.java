...
/**
 * Clase que representa la reduccion -> logico : expresion LLAND expresion
 *
 * @author César Pomar
 */
public final class LogAndBajo extends Logico {
     ...
     */
    public LogAndBajo(Expresion izquierda, Terminal operador, Expresion derecha) {
        super(operador);
